...
export function useDashboardCounts() {
  ...
  return {
    ...
    // Kept though no tile shows it: the conversion rate below is
    // converted / (converted + lost), and losing the denominator would turn an
    // honest ratio into "converted / converted".
    lostLeads: lostCount,
